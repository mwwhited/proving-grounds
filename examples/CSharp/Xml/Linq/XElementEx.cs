...
namespace Originations.DataProviders.Xml.Linq
{
    public static class XElementEx
    {
        ...
        public static string GetDescendantAsString(this XElement element, XName name)
        {
            ...
            return (string)element.Descendants(name).FirstOrDefault();
        }
        public static long? GetDescendantAsLong(this XElement element, XName name)
        {
            ...
            return (long?)element.Descendants(name).FirstOrDefault();
        }
        ...
        public static string GetTargetValue(this IEnumerable<XElement> elements, string name)
        {
            ...
            return elements.Where(e => string.Equals((string)e.Attribute("name"), name, StringComparison.InvariantCultureIgnoreCase))
