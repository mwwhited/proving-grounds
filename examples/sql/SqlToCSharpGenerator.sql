-- SQL to C# Type Mapping and Code Generation
-- Generates C# POCO property definitions from database table/view columns
-- Platform: SQL Server
--USE [YourDatabaseName];
--GO

-- Configure target table/view name
DECLARE @procName NVARCHAR(2000) = '[dbo].[YourTableOrViewName]';
